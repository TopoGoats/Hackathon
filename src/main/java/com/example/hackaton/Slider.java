...
public class Slider extends VBox {
    ...
    public Slider(String text, double ideal, double current, boolean isMoreBad) {
        ...
        Rectangle rectangle = new Rectangle(AnimalStats.panel_Width-100, (double) AnimalStats.panel_Height /10,linearGradient);
        Rectangle rectangle1 = new Rectangle(10,((double) AnimalStats.panel_Height /10)+10);
        double posX;
        if(!isMoreBad){
